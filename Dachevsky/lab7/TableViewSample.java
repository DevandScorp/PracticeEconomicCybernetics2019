...
public class TableViewSample extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Speaker's card");
        stage.setWidth(675);
        stage.setHeight(535);

        final Label label = new Label("Speaker's card");
        ...
        TableColumn<Person, String> trackDepartmentCol = new TableColumn<>("Topic");
        ...
        addFullName.setPromptText("Name");
