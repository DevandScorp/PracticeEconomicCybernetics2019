...
public class Main extends JComponent implements DragGestureListener, DragSourceListener, DropTargetListener, MouseListener, MouseMotionListener {
    ...
    private ArrayList<Cardioid> astroids = new ArrayList<>();
    private Cardioid currentScribble; // The scribble in progress
    private Cardioid beingDragged; // The scribble being dragged
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.setStroke(new Contur(1)); // Specify wide lines

        for (Cardioid astroid : astroids) {
            g2.draw(astroid); // Draw the scribble
        }
    ...
    public void mousePressed(MouseEvent e) {
        ...
        currentScribble = new Cardioid(e.getX(), e.getY(), param);
        astroids.add(currentScribble);
    ...
    public void dragGestureRecognized(DragGestureEvent e) {
        ...
        for (Cardioid astroid : astroids) {
            if (astroid.intersects(rectangle)) {
                ...
                Cardioid dragScribble = (Cardioid) astroid.clone();
    ...
    public void dragEnter(DropTargetDragEvent e) {
        if (e.isDataFlavorSupported(Cardioid.decDataFlavor) || e.isDataFlavorSupported(DataFlavor.stringFlavor)) {
    ...
    public void drop(DropTargetDropEvent e) {
        ...
        Cardioid droppedScribble;
        try {
            droppedScribble = (Cardioid) t.getTransferData(Cardioid.decDataFlavor);
        } catch (Exception ex) {
            try {
                String s = (String) t.getTransferData(DataFlavor.stringFlavor);
                droppedScribble = Cardioid.getFromString(s);
            } catch (Exception ex2) {
